...
var completedTasksHolder=document.querySelector(".section-complete");//completed-tasks
...
var createNewTaskElement=function(taskString){
  ...
  editInput.type="text";
  editInput.className="task input-text section__input";
...
var editTask=function(){
  ...
  var containsClass=listItem.classList.contains("section__item-edit");
  ...
  listItem.classList.toggle("section__item-edit");
};
